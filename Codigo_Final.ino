 ...
 * @date 29 Nov 2021
 * @brief <b> Codigo_Final do projeto Braco Robotico da materia Programacao de Hardware do 6 ciclo de Engenharia de Computacao.</b>
 *
...
/**
 * @brief Habilita as portas PD2, PD3 como saida.
 */
void LedModo(){
  DDRD |= (1 << PD2);
  DDRD |= (1 << PD3);
...
void manual(){
    ...
    if(P1>=812){             /**<A0 controlando PWM da porta 9, timer 1A*/
      ...
      if(OCR1A<=0){
        ...
        if(P2>=812){        /**<A1 controlando PWM da porta 10, timer 1B*/
       ...
       if(P3>=812){                 /**<A2 controlando PWM da porta 5, timer 0A*/
